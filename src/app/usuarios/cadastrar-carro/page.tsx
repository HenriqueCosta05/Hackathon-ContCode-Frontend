  ...
  return (
    <main className="flex flex-col w-full h-screen justify-center items-center">
      ...
      <p className="pt-2 text-center lg:w-10/12">
        Preencha o formulário para cadastro do seu veículo, identificando-o pela
        placa. Caso já haja cadastro associado à placa, redirecionaremos ao seu
      ...
      <form className="flex flex-col space-y-5 pt-5 items-center border-2 border-primary p-3 w-10/12 rounded-md my-4 lg:w-6/12">
        ...
        <div className="space-y-4 flex w-full flex-wrap">
          ...
          <div className="flex justify-between w-full gap-4">
            ...
            {currentStep < 2 ? (
              <>
                <Button text="Voltar ao Inicio" href="/" className="border border-primary text-primary hover:scale-[1.05] hover:transition-[.3s]"/>
